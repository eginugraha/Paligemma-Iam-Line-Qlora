...
The model runs on a RunPod GPU worker (see handler.py at the repo root). This class is a
...
that bridge; the server-side handler lives in handler.py at the repository root.
